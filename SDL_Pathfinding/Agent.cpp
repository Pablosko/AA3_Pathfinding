...
void Agent::CalculatePathFinding(Graph*graph, Vector2D point)
{
	for (auto cell : pathFinding->CalculatePath(graph, getPosition(), point).points) 
	{
		path.points.push_back(cell);
	}
}
