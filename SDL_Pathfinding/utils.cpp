...
void DrawPositionInMaze(Vector2D position, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	SDL_Rect rect;
	Vector2D coords;

	SDL_SetRenderDrawColor(TheApp::Instance()->getRenderer(), r, g, b, a);
	coords =position - Vector2D((float)CELL_SIZE / 2, (float)CELL_SIZE / 2);
